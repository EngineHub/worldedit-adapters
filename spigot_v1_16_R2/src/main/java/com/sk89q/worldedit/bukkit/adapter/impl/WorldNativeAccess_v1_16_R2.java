...
public class WorldNativeAccess_v1_16_R2 implements WorldNativeAccess<Chunk, IBlockData, BlockPosition> {
    ...
    public WorldNativeAccess_v1_16_R2(Spigot_v1_16_R2 adapter, WeakReference<World> world) {
    ...
    public boolean updateTileEntity(BlockPosition position, CompoundTag tag) {
        ...
        Spigot_v1_16_R2.readTagIntoTileEntity((NBTTagCompound) nativeTag, tileEntity);
        return true;
    }
