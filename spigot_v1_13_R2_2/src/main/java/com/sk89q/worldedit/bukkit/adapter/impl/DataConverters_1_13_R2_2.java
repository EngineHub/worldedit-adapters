...
import net.minecraft.server.v1_13_R2.UtilColor;
...
class DataConverters_1_13_R2_2 extends DataFixerBuilder implements com.sk89q.worldedit.world.DataFixer {
    ...
    public static DataConverters_1_13_R2_2 INSTANCE;
    ...
    DataConverters_1_13_R2_2(int dataVersion, Spigot_v1_13_R2_2 adapter) {
        super(dataVersion);
    ...
    private class WrappedDataFixer implements DataFixer {
        ...
        private NBTTagCompound convert(LegacyType type, NBTTagCompound cmp, int sourceVer, int desiredVersion) {
            List<DataConverter> converters = DataConverters_1_13_R2_2.this.converters.get(type);
            ...
            List<DataInspector> inspectors = DataConverters_1_13_R2_2.this.inspectors.get(type);
    ...
    private static class DataInspectorItemList extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String s : this.keys) {
                DataConverters_1_13_R2_2.convertItems(nbttagcompound, s, sourceVer, targetVer);
            }
    ...
    private static class DataInspectorItem extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String key : this.keys) {
                DataConverters_1_13_R2_2.convertItem(nbttagcompound, key, sourceVer, targetVer);
            }
