...
public class CBXNmsBlock_1710 extends NmsBlock {
     ...
     */
    public CBXNmsBlock_1710(int type, int data, TileEntityBlock tileEntityBlock) {
        super(type, data);
     ...
     */
    public CBXNmsBlock_1710(int type, int data, NBTTagCompound nbtData) {
        super(type, data);
     ...
     */
    public static CBXNmsBlock_1710 get(World world, Vector position, int type, int data) {
        ...
        if (te != null) {
            ...
            te.b(tag); // Load data
            return new CBXNmsBlock_1710(type, data, tag);
        }
    ...
    public static boolean set(World world, Vector position, BaseBlock block) {
        ...
        if (block instanceof CBXNmsBlock_1710) {
            CBXNmsBlock_1710 nmsProxyBlock = (CBXNmsBlock_1710) block;
            data = nmsProxyBlock.getNmsData(position);
        } else if (block instanceof TileEntityBlock) {
            CBXNmsBlock_1710 nmsProxyBlock = new CBXNmsBlock_1710(
