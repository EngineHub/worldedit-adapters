 ...
 */
public class CBXNmsBlock_175 extends NmsBlock {
     ...
     */
    public CBXNmsBlock_175(int type, int data, TileEntityBlock tileEntityBlock) {
        super(type, data);
     ...
     */
    public CBXNmsBlock_175(int type, int data, NBTTagCompound nbtData) {
        super(type, data);
     ...
     */
    public static CBXNmsBlock_175 get(World world, Vector position, int type, int data) {
        ...
        if (te != null) {
            ...
            te.b(tag); // Load data
            return new CBXNmsBlock_175(type, data, tag);
        }
    ...
    public static boolean set(World world, Vector position, BaseBlock block) {
        ...
        if (block instanceof CBXNmsBlock_175) {
            CBXNmsBlock_175 nmsProxyBlock = (CBXNmsBlock_175) block;
            data = nmsProxyBlock.getNmsData(position);
        } else if (block instanceof TileEntityBlock) {
            CBXNmsBlock_175 nmsProxyBlock = new CBXNmsBlock_175(
