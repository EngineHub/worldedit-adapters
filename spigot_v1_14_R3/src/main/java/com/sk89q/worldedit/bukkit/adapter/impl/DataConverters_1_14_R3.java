...
class DataConverters_1_14_R3 extends DataFixerBuilder implements com.sk89q.worldedit.world.DataFixer {
    ...
    private final Spigot_v1_14_R3 adapter;
    ...
    static DataConverters_1_14_R3 INSTANCE;
    ...
    DataConverters_1_14_R3(int dataVersion, Spigot_v1_14_R3 adapter) {
        super(dataVersion);
    ...
    private class WrappedDataFixer implements DataFixer {
        ...
        private NBTTagCompound convert(LegacyType type, NBTTagCompound cmp, int sourceVer, int desiredVersion) {
            List<DataConverter> converters = DataConverters_1_14_R3.this.converters.get(type);
            ...
            List<DataInspector> inspectors = DataConverters_1_14_R3.this.inspectors.get(type);
    ...
    private static class DataInspectorEntity implements DataInspector {
        ...
        private static final Logger a = LogManager.getLogger(DataConverters_1_14_R3.class);
    ...
    private static class DataInspectorItemList extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String s : this.keys) {
                DataConverters_1_14_R3.convertItems(nbttagcompound, s, sourceVer, targetVer);
            }
    ...
    private static class DataInspectorItem extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String key : this.keys) {
                DataConverters_1_14_R3.convertItem(nbttagcompound, key, sourceVer, targetVer);
            }
