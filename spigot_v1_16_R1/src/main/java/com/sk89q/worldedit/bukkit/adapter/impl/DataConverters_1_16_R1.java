...
import net.minecraft.server.v1_16_R1.UtilColor;
...
class DataConverters_1_16_R1 extends DataFixerBuilder implements com.sk89q.worldedit.world.DataFixer {
    ...
    static DataConverters_1_16_R1 INSTANCE;
    ...
    DataConverters_1_16_R1(int dataVersion, Spigot_v1_16_R1 adapter) {
        super(dataVersion);
    ...
    private class WrappedDataFixer implements DataFixer {
        ...
        private NBTTagCompound convert(LegacyType type, NBTTagCompound cmp, int sourceVer, int desiredVersion) {
            List<DataConverter> converters = DataConverters_1_16_R1.this.converters.get(type);
            ...
            List<DataInspector> inspectors = DataConverters_1_16_R1.this.inspectors.get(type);
    ...
    private static class DataInspectorEntity implements DataInspector {
        ...
        private static final Logger a = LogManager.getLogger(DataConverters_1_16_R1.class);
    ...
    private static class DataInspectorItemList extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String s : this.keys) {
                DataConverters_1_16_R1.convertItems(nbttagcompound, s, sourceVer, targetVer);
            }
    ...
    private static class DataInspectorItem extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String key : this.keys) {
                DataConverters_1_16_R1.convertItem(nbttagcompound, key, sourceVer, targetVer);
            }
