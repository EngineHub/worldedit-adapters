...
class DataConverters_1_14_R2 extends DataFixerBuilder implements com.sk89q.worldedit.world.DataFixer {
    ...
    DataConverters_1_14_R2(int dataVersion, Spigot_v1_14_R2 adapter) {
        super(dataVersion);
    ...
    private class WrappedDataFixer implements DataFixer {
        ...
        private NBTTagCompound convert(LegacyType type, NBTTagCompound cmp, int sourceVer, int desiredVersion) {
            List<DataConverter> converters = DataConverters_1_14_R2.this.converters.get(type);
            ...
            List<DataInspector> inspectors = DataConverters_1_14_R2.this.inspectors.get(type);
    ...
    private static class DataInspectorEntity implements DataInspector {
        ...
        private static final Logger a = LogManager.getLogger(DataConverters_1_14_R2.class);
    ...
    private static class DataInspectorItemList extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String s : this.keys) {
                DataConverters_1_14_R2.convertItems(nbttagcompound, s, sourceVer, targetVer);
            }
    ...
    private static class DataInspectorItem extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String key : this.keys) {
                DataConverters_1_14_R2.convertItem(nbttagcompound, key, sourceVer, targetVer);
            }
